...
def open_payment_window():
    ...
    # Cardholder Name
    cardholder_label = ttk.Label(payment_window, text="Cardholder Name:")
    cardholder_label.pack(pady=5)
    cardholder_entry = ttk.Entry(payment_window)
    cardholder_entry.pack(pady=5)

    # Card Number
    card_number_label = ttk.Label(payment_window, text="Card Number:")
    card_number_label.pack(pady=5)
    card_number_entry = ttk.Entry(payment_window)
    card_number_entry.pack(pady=5)

    # Expiry Date
    expiry_label = ttk.Label(payment_window, text="Expiry Date (MM/YY):")
    expiry_label.pack(pady=5)
    expiry_entry = ttk.Entry(payment_window)
    expiry_entry.pack(pady=5)

    # CVV
    cvv_label = ttk.Label(payment_window, text="CVV:")
    cvv_label.pack(pady=5)
    cvv_entry = ttk.Entry(payment_window, show="*")
    cvv_entry.pack(pady=5)

    # Pay button
    def process_payment():
        cardholder = cardholder_entry.get()
        ...
        if not cardholder or not card_number or not expiry or not cvv:
            ...
            messagebox.showerror("Invalid CVV", "CVV must be 3 digits")
        else:
            # Simulate successful payment
            messagebox.showinfo("Payment Successful", "Thank you! Your payment has been processed.")
...
# Menu images
displayDefaultImageObject = Image.open("Images/Image rest.png").resize((350,360))
...
CalamariDishLabel = ttk.Label(calamariDishFrame, text ="Fried Calamari ..... ₹140", style ="MenuLabel.TLabel")
CalamariDishLabel.grid(row = 0, column = 0, padx = 10, pady = 10, sticky = "W")

BurgerDishLabel = ttk.Label(burgerDishFrame, text ="Beach Burger ..... ₹220", style ="MenuLabel.TLabel")
BurgerDishLabel.grid(row = 0, column = 0, padx = 10, pady = 10, sticky = "W")

SalmonDishLabel = ttk.Label(salmonDishFrame, text ="Salmon Wonder ..... ₹250", style ="MenuLabel.TLabel")
SalmonDishLabel.grid(row = 0, column = 0, padx = 10, pady = 10, sticky = "W")

ShrimpDishLabel = ttk.Label(shrimpDishFrame, text ="Shrimp Tacos ..... ₹450", style ="MenuLabel.TLabel")
ShrimpDishLabel.grid(row = 0, column = 0, padx =10, pady = 10, sticky = "W")

SushiDishLabel = ttk.Label(sushiDishFrame, text ="Sushi Platter ..... ₹320", style ="MenuLabel.TLabel")
SushiDishLabel.grid(row = 0, column = 0, padx = 10, pady = 10, sticky = "W")

EmpanadasDishLabel = ttk.Label(empanadasDishFrame, text ="Empanadas .... ₹150", style ="MenuLabel.TLabel")
